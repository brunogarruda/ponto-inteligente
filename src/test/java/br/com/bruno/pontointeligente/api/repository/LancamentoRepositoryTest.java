...
import br.com.bruno.pontointeligente.api.utils.PasswordUtils;
...
public class LancamentoRepositoryTest {
	...
	public void testBuscarLancamentosPorFuncionarioIdPaginado() {
		...
		Page<Lancamento> lancamentos = this.lancamentoRepository.findByFuncionario_id(funcionarioId, page);
